...
let book8 = Book(id: UUID(), title: "Animal Farm", author: "George Orwell", date: "1945", genre: "Political Satire", emojis: ["🐷","🐶","🐓","🚜","👨‍🌾"], hint: "A group of  farm animals rebel against their human farmer to create a new society.")
let book9 = Book(id: UUID(), title: "A Thousands Splendid Suns", author: "Khaled Hosseini", date: "2007", genre: "Novel", emojis: ["∞","🤩","☀️","☀️"], hint: "Mariam, the protagonist, lives on the outskirts of Herat with her mother.")
